...
export default function App() {
  return (
    <div id="top" className="min-h-screen bg-[#120d0b] text-[#f5efe6]">
      ...
      <header className="sticky top-0 z-30 border-b border-[#c4a66a]/15 bg-[#140f0d]/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div>
            <div className="font-serif text-xl tracking-[0.34em] text-[#f8f1e8]">
              S-STAGE
            </div>
            <div className="mt-1 text-xs text-[#c9b8a2]">
              IMMERSIVE ENTERTAINMENT · SPACE VALUE · CONTENT
            </div>
          </div>
          <nav className="hidden md:flex items-center gap-8 text-sm text-[#d8cab9]">
            <a href="#about" className="transition-colors hover:text-[#f6d8a0]">
              会社概要
            </a>
            <a
              href="#services"
              className="transition-colors hover:text-[#f6d8a0]"
            >
              事業内容
            </a>
            <a href="#brand" className="transition-colors hover:text-[#f6d8a0]">
              ブランド空間
            </a>
            <a
              href="#contact"
            ...
            {[
              ...
              >
                <div className="flex h-full min-h-[170px] flex-col justify-end rounded-[1.35rem] border border-white/8 bg-black/20 p-5">
                  <div className="text-xs uppercase tracking-[0.22em] text-[#dfc08a]">
                    S-STAGE Aesthetic
                  </div>
                  <div className="mt-3 font-serif text-lg leading-7 text-[#f8f0e5]">
                    {item}
                  </div>
                </div>
              </div>
      ...
      <section id="about" className="border-t border-[#c4a66a]/12">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-2 lg:py-28">
          <motion.div
            ...
            variants={fadeUp}
          >
            <div className="text-sm uppercase tracking-[0.24em] text-[#d3b177]">
              About
            </div>
            <h2 className="mt-4 font-serif text-3xl text-[#fbf5ed] md:text-5xl">
              会社概要
            </h2>
          ...
          >
            <Card className="border-[#c4a66a]/15 bg-[linear-gradient(180deg,rgba(82,24,20,0.18),rgba(22,14,12,0.82))] shadow-2xl shadow-black/25 backdrop-blur-sm">
              <CardContent className="p-8">
                <div className="text-sm uppercase tracking-[0.22em] text-[#d9ba83]">
                  Core Positioning
                </div>
                ...
                >
                  <Card className="h-full border-[#c4a66a]/14 bg-[linear-gradient(180deg,rgba(48,24,20,0.55),rgba(18,12,10,0.88))] shadow-xl shadow-black/20 backdrop-blur-sm">
                    <CardContent className="p-7">
                      ...
                      <h3 className="mt-5 text-lg font-medium leading-7 text-[#fbf5ed]">
                        {s.title}
                      </h3>
      ...
      <section id="brand" className="border-t border-[#c4a66a]/12">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:py-28">
          ...
          <div className="mt-12 grid items-stretch gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="rounded-[2rem] border border-[#c4a66a]/14 bg-[linear-gradient(180deg,rgba(108,31,24,0.18),rgba(20,13,11,0.92))] p-4 shadow-2xl shadow-black/25">
              <div className="relative min-h-[420px] overflow-hidden rounded-[1.5rem] border border-[#d5b06d]/10">
                <img
                  src="/brand.jpg"
                  alt="LOUNGE D"
                  className="h-full w-full object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#120d0b]/75 via-[#120d0b]/25 to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                  <div className="text-sm uppercase tracking-[0.22em] text-[#d9ba83]">
                    Current Operating Space
                  </div>
                  <h3 className="mt-3 font-serif text-3xl text-[#fbf5ed] md:text-4xl">
                    LOUNGE D
                  </h3>
                  <p className="mt-4 max-w-xl leading-8 text-[#e6d7c4]">
                    蝋燭の灯り、重厚な家具、深い色調、そして物語性を備えた空間演出により、
                    滞在そのものが体験になるイマーシブ・ラウンジ。
                  </p>
                </div>
              </div>
            </div>
                  ...
                  >
                    <Card className="h-full border-[#c4a66a]/14 bg-[linear-gradient(180deg,rgba(63,20,16,0.5),rgba(20,13,11,0.9))] shadow-xl shadow-black/20 backdrop-blur-sm">
                      <CardContent className="p-6">
                        ...
                        <div className="mt-5 font-serif text-xl text-[#fbf5ed]">
                          {item.title}
                        </div>
                        <p className="mt-3 leading-7 text-[#d7c5b0]">
                          {item.desc}
                        </p>
                      </CardContent>
                    </Card>
      ...
      <footer className="border-t border-[#c4a66a]/12">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-8 text-sm text-[#bda992] md:flex-row md:items-center md:justify-between">
          ...
          <div className="uppercase tracking-[0.2em] text-[#c8b39c]">
            Immersive · Hospitality · Content · Space
          </div>
        </div>
      </footer>
    </div>
